...
public class CodeSmellDetector {
    ...
    public static void detectSmell(String projectName) throws IOException {
        ...
        PrintWriter printWriter = new PrintWriter("C:\\Users\\bacco\\OneDrive\\Desktop\\progetti uni\\SDAF_on_FOSS\\src\\main\\java\\sw_dep_proj\\other_data\\" + projectName + "Smells.txt");
