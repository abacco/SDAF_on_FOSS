...
public class CKMetrics {
    ...
    // lines of code (include comments)
    ...
    //  is a software metric used to indicate the complexity of a program.
    ...
    // Halstead Vocabulary represents the total number of distinct operators and operands in a function.
    // n = n1 + n2,
    ...
    // metrics of the software should reflect the implementation or expression of algorithms in different languages,
    // but be independent of their execution on a specific platform
    ...
    // MPC - method per class invocation (?)
